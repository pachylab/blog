---
title: "Week 15 Day 07: 주간 복습과 detection backlog"
draft: true
---

# Week 15 Day 07: 주간 복습과 detection backlog

## 오늘의 목표

- YARA, Sigma, Sysmon를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- Zeek, Suricata, false positive가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
YARA, Sigma, Sysmon, Zeek, Suricata, false positive, ATT&CK
...
- ATT&CK: malware taxonomy를 기능, 전달 방식, persistence, C2 필요성으로 구분하고 IOC와 TTP를 분리한다.
...
- Week 15 detection backlog와 우선순위
...
3. Sysmon를 user-mode 도구 출력과 kernel/object 관점으로 동시에 설명할 수 있는가?
4. Zeek를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
5. Suricata를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
6. false positive를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
7. 오늘 산출물인 "Week 15 detection backlog와 우선순위"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
