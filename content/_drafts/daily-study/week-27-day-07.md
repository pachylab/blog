---
title: "Week 27 Day 07: 주간 복습과 forensic report"
draft: true
---

# Week 27 Day 07: 주간 복습과 forensic report

## 오늘의 목표

- disk image, partition, file carving를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- timestamp, MFT, ext4 journal가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
disk image, partition, file carving, timestamp, MFT, ext4 journal, timeline
...
- Week 27 disk forensics report 1차본
...
5. MFT artifact가 증명할 수 있는 행위와 증명할 수 없는 행위는 무엇인가?
6. ext4 journal를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
7. 오늘 산출물인 "Week 27 disk forensics report 1차본"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
