---
title: "Week 17 Day 06: custom packer와 import reconstruction"
draft: true
---

# Week 17 Day 06: custom packer와 import reconstruction

## 오늘의 목표

- custom packer, import reconstruction, IAT를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- Scylla, loader stub, relocation가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
custom packer, import reconstruction, IAT, Scylla, loader stub, relocation, anti-dump

## 반드시 정리할 개념

- custom packer: custom packer의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
- Scylla: Scylla의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
- loader stub: source에서 executable까지 생성되는 artifact와 symbol/relocation/debug information이 reversing에 주는 단서를 정리한다.
- relocation: source에서 executable까지 생성되는 artifact와 symbol/relocation/debug information이 reversing에 주는 단서를 정리한다.
- anti-dump: anti-dump의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
- import reconstruction 절차와 실패 조건
- 오늘 배운 키워드 중 3개를 골라 정의, 관찰 방법, 보안 분석에서의 쓰임을 각각 2문장 이상으로 정리한다.
- 실습이 실패했다면 실패한 명령어, 에러 메시지, 추정 원인, 다음 확인 지점을 그대로 남긴다.

## 복습 질문

1. custom packer를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
2. import reconstruction를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
3. IAT 구조가 loader, dynamic linking, import resolution 중 어느 단계와 연결되는가?
4. Scylla를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
5. loader stub 유형을 기능, persistence, C2, payload 관점에서 다른 유형과 구분할 수 있는가?
6. relocation 단계에서 생성되거나 소비되는 artifact는 무엇이고 reversing에서는 어디서 확인하는가?
7. 오늘 산출물인 "import reconstruction 절차와 실패 조건"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
