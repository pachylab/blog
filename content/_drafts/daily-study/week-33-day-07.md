---
title: "Week 33 Day 07: 주간 복습과 malware crypto report"
draft: true
---

# Week 33 Day 07: 주간 복습과 malware crypto report

## 오늘의 목표

- KDF, salt, CSPRNG를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- config decryption, ransomware encryption, hash-based IOC가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
KDF, salt, CSPRNG, config decryption, ransomware encryption, hash-based IOC, nonce reuse
...
- CSPRNG: CSPRNG의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
- config decryption: config decryption의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
- Week 33 malware crypto mini report
...
3. CSPRNG를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
4. config decryption를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
5. ransomware encryption 유형을 기능, persistence, C2, payload 관점에서 다른 유형과 구분할 수 있는가?
6. hash-based IOC를 보고서나 rule로 쓸 때 false positive를 줄이기 위한 조건은 무엇인가?
7. 오늘 산출물인 "Week 33 malware crypto mini report"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
