---
title: "Week 06 Day 07: 주간 복습과 pwn/reversing 연결"
draft: true
---

# Week 06 Day 07: 주간 복습과 pwn/reversing 연결

## 오늘의 목표

- pointer, struct, signedness를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- function pointer, memory safety, ownership가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
pointer, struct, signedness, function pointer, memory safety, ownership
...
- memory safety: memory safety의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
- Week 06 C 취약점 seed 목록
- 오늘 배운 키워드 중 3개를 골라 정의, 관찰 방법, 보안 분석에서의 쓰임을 각각 2문장 이상으로 정리한다.
- 실습이 실패했다면 실패한 명령어, 에러 메시지, 추정 원인, 다음 확인 지점을 그대로 남긴다.

## 복습 질문

1. pointer의 메모리 배치를 그릴 수 있고 잘못 쓰면 어떤 memory safety 문제가 생기는가?
2. struct의 메모리 배치를 그릴 수 있고 잘못 쓰면 어떤 memory safety 문제가 생기는가?
3. signedness를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
4. function pointer 관점에서 입력 집합, 출력 집합, 매핑 규칙을 보안 로그 예시로 설명할 수 있는가?
5. memory safety를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
6. ownership를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
7. 오늘 산출물인 "Week 06 C 취약점 seed 목록"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
