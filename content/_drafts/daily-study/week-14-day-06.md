---
title: "Week 14 Day 06: report structure와 근거 분리"
draft: true
---

# Week 14 Day 06: report structure와 근거 분리

## 오늘의 목표

- report structure, executive summary, technical findings를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- evidence, assumption, limitation가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
report structure, executive summary, technical findings, evidence, assumption, limitation, appendix

## 반드시 정리할 개념

- report structure: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- executive summary: executive summary의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
- technical findings: technical findings의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
- appendix: appendix의 정의, 관찰 가능한 artifact, 보안 분석에서 쓰이는 지점, 혼동하기 쉬운 개념을 2-3문장으로 정리한다.
...
2. executive summary를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
3. technical findings를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
4. evidence를 기록할 때 hash, 시간, 도구 버전, 분석자, 원본/복제본 구분 중 무엇이 빠지면 신뢰성이 약해지는가?
5. assumption를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
6. limitation를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
7. 오늘 산출물인 "malware triage report 목차 초안"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
