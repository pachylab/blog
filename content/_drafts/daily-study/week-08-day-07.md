---
title: "Week 08 Day 07: 주간 복습과 DFIR 연결"
draft: true
---

# Week 08 Day 07: 주간 복습과 DFIR 연결

## 오늘의 목표

- metadata, timestamp, MFT를 자료의 정의, 실습 관찰, 보안 분석 쓰임으로 나누어 설명한다.
- journal, forensic image, file carving가 실제 artifact, primitive, IOC, evidence 중 어디에 연결되는지 예시를 남긴다.
...
metadata, timestamp, MFT, journal, forensic image, file carving, timeline
...
- Week 08 파일시스템 포렌식 질문 목록
- 오늘 배운 키워드 중 3개를 골라 정의, 관찰 방법, 보안 분석에서의 쓰임을 각각 2문장 이상으로 정리한다.
- 실습이 실패했다면 실패한 명령어, 에러 메시지, 추정 원인, 다음 확인 지점을 그대로 남긴다.

## 복습 질문

1. metadata를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
2. timestamp artifact가 증명할 수 있는 행위와 증명할 수 없는 행위는 무엇인가?
3. MFT artifact가 증명할 수 있는 행위와 증명할 수 없는 행위는 무엇인가?
4. journal를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
5. forensic image를 오늘 실습 결과와 연결해 설명하면 입력, 처리 과정, 출력, 한계는 무엇인가?
6. file carving artifact가 증명할 수 있는 행위와 증명할 수 없는 행위는 무엇인가?
7. 오늘 산출물인 "Week 08 파일시스템 포렌식 질문 목록"이 다음 분석 단계에서 재사용 가능하려면 어떤 정보가 더 필요한가?
