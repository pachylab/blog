...
- portfolio, artifact selection, report를 기준으로 지난 40주 산출물을 점검하고 강점, 공백, 보완 작업을 분리한다.
- writeup, tool note, code quality를 실제 포트폴리오 정리, 공개/비공개 분류, 다음 12주 계획에 반영한다.
...
- portfolio: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- artifact selection: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- report: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- writeup: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- tool note: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
- code quality: 포트폴리오 산출물은 재현성, 기술 깊이, 근거 품질, 공개 가능성으로 평가한다. 민감 정보와 dual-use 세부사항은 분리한다.
...
1. portfolio를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
2. artifact selection를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
3. report를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
4. writeup를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
5. tool note를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
6. code quality를 공개 후보로 고를 때 재현성, 근거 품질, 민감 정보 제거, 읽는 사람의 맥락 중 무엇을 확인해야 하는가?
